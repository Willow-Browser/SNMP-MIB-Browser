...
# ASN.1 source http://www.net-snmp.org:80/docs/mibs/SNMPv2-MIB.txt
# Produced by pysmi-0.3.4 at Wed May 18 22:29:34 2022
# On host ? platform ? version ? by user ?
# Using Python version 3.10.0 (tags/v3.10.0:b494f59, Oct  4 2021, 19:00:18) [MSC v.1929 64 bit (AMD64)]
#
Integer, OctetString, ObjectIdentifier = mibBuilder.importSymbols("ASN1", "Integer", "OctetString", "ObjectIdentifier")
NamedValues, = mibBuilder.importSymbols("ASN1-ENUMERATION", "NamedValues")
ConstraintsIntersection, ValueRangeConstraint, ConstraintsUnion, SingleValueConstraint, ValueSizeConstraint = mibBuilder.importSymbols("ASN1-REFINEMENT", "ConstraintsIntersection", "ValueRangeConstraint", "ConstraintsUnion", "SingleValueConstraint", "ValueSizeConstraint")
ObjectGroup, ModuleCompliance, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "ModuleCompliance", "NotificationGroup")
NotificationType, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, Integer32, Counter64, Unsigned32, mib_2, MibIdentifier, ObjectIdentity, IpAddress, snmpModules, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "Integer32", "Counter64", "Unsigned32", "mib-2", "MibIdentifier", "ObjectIdentity", "IpAddress", "snmpModules", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("SNMPv2-MIB", snmpWarmStartNotificationGroup=snmpWarmStartNotificationGroup, snmpSilentDrops=snmpSilentDrops, snmpOutBadValues=snmpOutBadValues, snmp=snmp, sysORID=sysORID, sysServices=sysServices, PYSNMP_MODULE_ID=snmpMIB, snmpTrap=snmpTrap, sysOREntry=sysOREntry, snmpOutTraps=snmpOutTraps, systemGroup=systemGroup, snmpInBadVersions=snmpInBadVersions, snmpInGetRequests=snmpInGetRequests, snmpInNoSuchNames=snmpInNoSuchNames, snmpMIBConformance=snmpMIBConformance, snmpOutTooBigs=snmpOutTooBigs, sysUpTime=sysUpTime, snmpMIBObjects=snmpMIBObjects, snmpInGetNexts=snmpInGetNexts, snmpBasicCompliance=snmpBasicCompliance, snmpSetSerialNo=snmpSetSerialNo, snmpCommunityGroup=snmpCommunityGroup, snmpOutPkts=snmpOutPkts, sysContact=sysContact, snmpInPkts=snmpInPkts, snmpInTooBigs=snmpInTooBigs, snmpInTotalSetVars=snmpInTotalSetVars, snmpOutNoSuchNames=snmpOutNoSuchNames, snmpOutGetRequests=snmpOutGetRequests, sysLocation=sysLocation, snmpOutSetRequests=snmpOutSetRequests, sysORUpTime=sysORUpTime, snmpOutGetResponses=snmpOutGetResponses, snmpBasicComplianceRev2=snmpBasicComplianceRev2, snmpTraps=snmpTraps, sysDescr=sysDescr, snmpMIB=snmpMIB, coldStart=coldStart, snmpInASNParseErrs=snmpInASNParseErrs, sysName=sysName, sysORTable=sysORTable, snmpNotificationGroup=snmpNotificationGroup, snmpInTraps=snmpInTraps, sysObjectID=sysObjectID, snmpInTotalReqVars=snmpInTotalReqVars, warmStart=warmStart, snmpSetGroup=snmpSetGroup, snmpInGetResponses=snmpInGetResponses, system=system, snmpInBadValues=snmpInBadValues, snmpGroup=snmpGroup, sysORLastChange=sysORLastChange, authenticationFailure=authenticationFailure, snmpOutGenErrs=snmpOutGenErrs, snmpInBadCommunityNames=snmpInBadCommunityNames, snmpSet=snmpSet, snmpInBadCommunityUses=snmpInBadCommunityUses, snmpEnableAuthenTraps=snmpEnableAuthenTraps, snmpTrapOID=snmpTrapOID, snmpMIBGroups=snmpMIBGroups, snmpInGenErrs=snmpInGenErrs, snmpOutGetNexts=snmpOutGetNexts, sysORIndex=sysORIndex, snmpTrapEnterprise=snmpTrapEnterprise, snmpBasicNotificationsGroup=snmpBasicNotificationsGroup, snmpObsoleteGroup=snmpObsoleteGroup, snmpMIBCompliances=snmpMIBCompliances, snmpInReadOnlys=snmpInReadOnlys, snmpProxyDrops=snmpProxyDrops, snmpInSetRequests=snmpInSetRequests, sysORDescr=sysORDescr)
